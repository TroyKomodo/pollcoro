...
POLLCORO_EXPORT namespace pollcoro {
    ...
    class chain_stream_awaitable : public awaitable_maybe_blocks<StreamAwaitables...> {
        ...
        POLLCORO_STATIC_ASSERT_STREAM(StreamAwaitables...);
    ...
    constexpr auto chain(StreamAwaitables && ... streams) {
        return chain_stream_awaitable<StreamAwaitables...>(
    ...
    chain_stream_awaitable<StreamAwaitable, StreamAwaitables...> operator|(
        StreamAwaitable&& stream, chain_stream_awaitable<StreamAwaitables...>&& chain
    ) {
